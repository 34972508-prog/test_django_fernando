...
SECRET_KEY = 'django-insecure-&yic+(w_35)p%@m!-#v2*mh#l8a7v)_$q#s-#4yvlfy_ir2_j$'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # si BASE_DIR es str; si es Path usa BASE_DIR